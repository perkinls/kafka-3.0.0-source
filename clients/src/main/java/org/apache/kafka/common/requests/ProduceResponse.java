...
public class ProduceResponse extends AbstractResponse {
    ...
    public static final class PartitionResponse {
        public Errors error;
        /*
         * 第一条消息分配的offset的值, 为什么需要这个值？
         *  因为我们在发送完消息后，需要知道这个消息的在服务端的offset，这样我们就不需要知道这个RecordBatch中所有消息的offset了，
         *  只需要知道第一个消息的offset，再集合自身在RecordBatch中的相对偏移量，就可以计算出来当前消息在服务端分区中的偏移量了。
         */

        public long baseOffset; // 第一条消息分配的offset的值
